...
GNSS_data Get_GNSS_data(GNSS_data GNSS_data, int epoch) {
	...
	out.rinex_obs.obs.year[0] = GNSS_data.rinex_obs.obs.year[epoch];
	out.rinex_obs.obs.month[0] = GNSS_data.rinex_obs.obs.month[epoch];
	out.rinex_obs.obs.day[0] = GNSS_data.rinex_obs.obs.day[epoch];
	out.rinex_obs.obs.hour[0] = GNSS_data.rinex_obs.obs.hour[epoch];
	out.rinex_obs.obs.min[0] = GNSS_data.rinex_obs.obs.min[epoch];
	out.rinex_obs.obs.sec[0] = GNSS_data.rinex_obs.obs.sec[epoch];
	out.rinex_obs.obs.iTOW[0] = GNSS_data.rinex_obs.obs.iTOW[epoch];

	out.rinex_obs.obs.numSV_L1[0] = GNSS_data.rinex_obs.obs.numSV_L1[epoch];
	...
	out.rinex_obs.obs.numSV_L2[0] = GNSS_data.rinex_obs.obs.numSV_L2[epoch];
	...
	out.rinex_obs.obs.numSV_L5[0] = GNSS_data.rinex_obs.obs.numSV_L5[epoch];
